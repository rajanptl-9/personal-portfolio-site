                ...
                <ul class="progress">
                    <li class="progress__item progress__item--completed">
                        <div className='education_text'>
                            <a href='https://www.svnit.ac.in/' target='_blank' rel="noopener noreferrer" className='progress__title' style={{ textDecoration: "none", fontSize: "24px", fontWeight: "600", textAlign: "center", color: "#233b5a" }}>SMT M.R.C. High School Dihen (2018) <FontAwesomeIcon icon={faArrowUpRightFromSquare} style={{ fontSize: "22px" }} /></a>
